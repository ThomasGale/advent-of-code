...
namespace aoc::utils {
	...
	public:
		...
		//bool operator<(const Mat2x2& rhs) const { return I < rhs.I || J < rhs.J; }; // Experimental just for map.
		Mat2x2 operator+(const Mat2x2& rhs) const { return Mat2x2(I + rhs.I, J + rhs.J); };
		Mat2x2 operator-(const Mat2x2& rhs) const { return Mat2x2(I - rhs.I, J - rhs.J); };
